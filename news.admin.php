...
if (/*IsAdmin()*/true) {
	echo "<h4>Додати новину:</h4>";
	echo "<form action=\"/add/news\"  method=\"post\"
enctype=\"multipart/form-data\" target=\"_self\">";
	...
	echo "<tr><td><label for=\"date\">Дата:</label></td><td><input type=\"date\" name=\"date\" required=\"true\"></input></td></tr>";
